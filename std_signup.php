...
<body>
    ...
    <div class="container">
        ...
        <div class="signup-form">
            ...
            <form method="POST" action="stdlogin_logic.php" enctype="multipart/form-data">
                ...
                <input class="rollno" type="number" name="rollno" placeholder="Rollno" required><br>
                <input class="course" type="text" name="course" id="course" placeholder="Course" required>
